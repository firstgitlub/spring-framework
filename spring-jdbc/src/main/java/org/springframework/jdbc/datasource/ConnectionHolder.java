 ...
 *
 * ConnectionHolder：Connection的持有器。
 * 通过ConnectionHandler来完成对Connection的操作:) 典型的委派。
 *
...
public class ConnectionHolder extends ResourceHolderSupport {
	 ...
	 * 这对于期望“连接借用”的ConnectionHandles是必要的，
	 * 在这种情况下，每个返回的连接只是临时租用的，
	 * 在完成数据操作后需要返回，以使该连接可用于同一事务中的其他操作。
	 *
	 */
	@Override
