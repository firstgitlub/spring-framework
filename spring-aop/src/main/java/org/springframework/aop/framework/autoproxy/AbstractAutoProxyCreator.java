...
public abstract class AbstractAutoProxyCreator extends ProxyProcessorSupport
	 ...
	 *
	 * 如果需要，包装给定的bean，也就是说，如果它符合被代理的条件。
	 *
	...
	protected Object wrapIfNecessary(Object bean, String beanName, Object cacheKey) {
		...
		// Create proxy if we have advice.  创建代理如果我们有建议。
		// 如果存在 增强方法 或 增强器 则创建代理
	...
	protected Object createProxy(Class<?> beanClass, @Nullable String beanName,
		...
		// 加入增强器  封装 Advisor 并加入到 ProxyFactory 中
		...
		// 定制代理，留作子类扩展
		// 当然Spring为子类提供了定制初始化 ProxyFactory 的函数
		// customizeProxyFactory(proxyFactory)，子类可以在此函数中进行对 ProxyFactory 的进一步封装
	 ...
	 *
	 * 由于Spring中涉及过多的拦截器、增强器、增强方法等方式进行逻辑增强，
	 * 有必要将他们统一封装成Advisor来进行代理的创建，完成增强的封装过程
	 *
	 */
