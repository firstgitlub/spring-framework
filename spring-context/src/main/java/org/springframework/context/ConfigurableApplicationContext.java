...
public interface ConfigurableApplicationContext extends ApplicationContext, Lifecycle, Closeable {
	 ...
	 */
	String CONVERSION_SERVICE_BEAN_NAME = "conversionService";// conversion : 转换
	 ...
	 *
	 * 加载或刷新配置的持久表示，可能来自基于java的配置、XML文件、属性文件、关系数据库模式或其他一些格式。
	 * 由于这是一个启动方法，如果失败，它应该销毁已经创建的单例，
	 * 以避免悬空资源。换句话说，在调用此方法之后，要么全部实例化，要么根本不实例化单例。
	 *
