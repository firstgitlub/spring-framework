...
public class UrlBasedViewResolver extends AbstractCachingViewResolver implements Ordered {
	...
	/**
	 *
	 * 对于视图对象，Spring采用了缓存机制。我们这里主要分析新建视图的逻辑。
	 * 新建视图主要依赖 createView(viewName, locale) 实现。
	 *
	 * 我们进入 AbstractCachingViewResolver 的子类 UrlBasedViewResolver
	 * 中的 createView(viewName, locale) 方法
	 *
	 *
	 ...
	 *
	 * 这一段函数层层调用，主要是将创建一个具体的 view 对象，
	 * 额外将视图解析器中的一些属性设置给 view 对象中
	 *
	 */
